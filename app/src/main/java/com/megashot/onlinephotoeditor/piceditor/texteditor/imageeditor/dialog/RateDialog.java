package com.megashot.onlinephotoeditor.piceditor.texteditor.imageeditor.dialog;
...
public class RateDialog extends Dialog implements View.OnClickListener {
    ...
    private void initView() {
        ...
        findViewById(R.id.text_view_later).setOnClickListener(this);
    ...
    public void onClick(View view) {
        ...
        if (id != R.id.text_view_later) {
            if (id != R.id.text_view_submit) {
                ...
                if (i >= 4) {
                    this.context.startActivity(new Intent("android.intent.action.VIEW", Uri.parse("https://play.google.com/store/apps/details?id="+context.getPackageName())));
