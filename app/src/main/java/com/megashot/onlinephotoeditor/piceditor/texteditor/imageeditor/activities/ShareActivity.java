...
import com.megashot.onlinephotoeditor.piceditor.texteditor.imageeditor.dialog.RateDialog;
...
import static com.megashot.onlinephotoeditor.piceditor.texteditor.imageeditor.activities.EditImageActivity.KEY_IMAGE_PATH;
...
public class ShareActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void onCreate(Bundle bundle) {
        ...
        file = new File(getIntent().getExtras().getString(KEY_IMAGE_PATH));
    ...
    public void onClick(View view) {
        if (view != null) {
            ...
            if (id == R.id.image_view_back) {
                ...
                intent4.setDataAndType(FileProvider.getUriForFile(getApplicationContext(), "com.megashot.onlinephotoeditor.piceditor.texteditor.imageeditor.provider", this.file), "image/*");
    ...
    private Uri createCacheFile() {
        return FileProvider.getUriForFile(getApplicationContext(), "com.megashot.onlinephotoeditor.piceditor.texteditor.imageeditor.provider", this.file);
    }
}
