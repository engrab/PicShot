...
public class ToolsAdapter extends RecyclerView.Adapter<ToolsAdapter.ViewHolder> {
    ...
    class ToolModel {
        ...
        ToolModel(String str, int i, ToolType toolType2) {
            this.toolName = str;
            this.toolIcon = i;
        ...
        ViewHolder(View view) {
            ...
            relativeLayout.setOnClickListener(new View.OnClickListener() {
                public final void onClick(View view) {
                    ViewHolder.this.lambda$new$0$ToolsAdapter$ViewHolder(view);
                }
            });
        }

        public /* synthetic */ void lambda$new$0$ToolsAdapter$ViewHolder(View view1) {
